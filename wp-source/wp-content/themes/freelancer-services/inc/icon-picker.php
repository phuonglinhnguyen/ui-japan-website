...
class Freelancer_Services_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'freelancer-services' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $freelancer_services_font_awesome_icon_array = freelancer_services_font_awesome_icon_array();
                    foreach ($freelancer_services_font_awesome_icon_array as $freelancer_services_font_awesome_icon) {
                            $icon_class = $this->value() == $freelancer_services_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($freelancer_services_font_awesome_icon).'"></i>
                            <span class="freelancer-services-social-class">'.esc_attr($freelancer_services_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function freelancer_services_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'freelancer-services-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'freelancer_services_customizer_script' );

if(!function_exists('freelancer_services_font_awesome_icon_array')){
    function freelancer_services_font_awesome_icon_array(){
